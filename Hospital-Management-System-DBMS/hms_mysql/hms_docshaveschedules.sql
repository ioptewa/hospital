...
CREATE TABLE `docshaveschedules` (
  ...
  KEY `docshaveschedules_ibfk_2` (`doctor`),
  CONSTRAINT `docshaveschedules_ibfk_1` FOREIGN KEY (`sched`) REFERENCES `schedule` (`id`) ON DELETE CASCADE,
  CONSTRAINT `docshaveschedules_ibfk_2` FOREIGN KEY (`doctor`) REFERENCES `doctor` (`email`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `docshaveschedules` VALUES (1,'hathalye7666@gmail.com'),(2,'hathalye7666@gmail.com'),(3,'hathalye7666@gmail.com'),(4,'hathalye7666@gmail.com'),(5,'hathalye8@gmail.com'),(6,'hathalye8@gmail.com');
